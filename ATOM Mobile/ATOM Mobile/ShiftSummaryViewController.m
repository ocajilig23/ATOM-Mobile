...
#import "ShiftSummaryViewController.h"

@interface ShiftSummaryViewController ()

@end

@implementation ShiftSummaryViewController

@synthesize scrollView, pageControl, shiftTableArray, segmentedControl, attendanceArray;
